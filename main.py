...
- You NEVER answer data questions yourself.
- You NEVER say you cannot access files, attachments, or Excel.
- ALL questions related to recruitment, HR, candidates, interviews, offers,
  recruiters, requirements, or data MUST be routed to the supervisor.

If the user asks ANY recruitment or HR-related question,
respond ONLY with:
ROUTE_TO_SUPERVISOR: <cleaned_question>

If the question is clearly unrelated to HR or recruitment,
...
# ---- HARD CLEANING FOR LLM ----
        enriched = (
            enriched
            .replace("attached excel", "")
            .replace("attached Excel", "")
